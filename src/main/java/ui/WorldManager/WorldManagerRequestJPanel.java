 ...
 * @author changxu
 */
public class WorldManagerRequestJPanel extends javax.swing.JPanel {

    /**
     * Creates new form WorldManagerRequestJPanel
     */
    JPanel userProcessContainer;    
    UserAccount account;
    Business business;
    
    public WorldManagerRequestJPanel(JPanel userProcessContainer, UserAccount account) {
        initComponents();
    ...
    public void refreshRequestTable(){
        ...
        for(Country country: business.getCountryDirectory().getName2Country().values()){
            for(Request r: country.getRequestList()){
                if(r.getWorldManager() == account.getOrganization()){
                    Object[] row = new Object[5];
                    SimpleDateFormat df = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
                    row[0] = df.format(r.getRequestDate());
                    row[1] = r.getRequestType().toString();
                    row[2] = r.getCountryManager()==null?"":r.getCountryManager().getName();                    
                    row[3] = r;
    ...
    private void initComponents() {
        ...
        tblRequest.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Request Date", "Request Type", "Country Manager", "Title", "Status"
            }
        ));
    ...
    private void btnViewReceivedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewReceivedActionPerformed
        ...
        Request r = (Request) tblRequest.getValueAt(indexRow, 3);
        WorldViewRequestJPanel wvrjp = (WorldViewRequestJPanel) new WorldViewRequestJPanel(userProcessContainer, account, r);
        userProcessContainer.add("WorldViewRequestJPanel", wvrjp);
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        // TODO add your handling code here:
        WorldManagerCreateReqJPanel wmcrj = (WorldManagerCreateReqJPanel) new WorldManagerCreateReqJPanel(userProcessContainer, account);
        userProcessContainer.add("WorldManagerCreateReqJPanel", wmcrj);
        CardLayout crdLyt = (CardLayout) userProcessContainer.getLayout();
        crdLyt.next(userProcessContainer);
