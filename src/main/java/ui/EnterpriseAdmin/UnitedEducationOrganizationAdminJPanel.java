...
import model.Enterprise.UnitedEduOrg;
 ...
 * @author aprilyz
 */
public class UnitedEducationOrganizationAdminJPanel extends javax.swing.JPanel {

    Business business = Business.getInstance();
    JPanel workArea;
    UserAccount account;
    UnitedEduOrg unitedEduOrg;
    
    /**
     * Creates new form UnitedEducationOrganizationAdminJPanel
     */
    public UnitedEducationOrganizationAdminJPanel(JPanel workArea, UserAccount account) {
        this.workArea = workArea;
        this.account = account;
        this.unitedEduOrg = (UnitedEduOrg)account.getOrganization().getEnterprise();
        initComponents();
        populateComboOrgType();
        lblEnterprise.setText(unitedEduOrg.getName());
        refreshTable();
    ...
    private void populateComboOrgType(){
        for (Organization.OrgType type : Organization.OrgType.values()) {
            if (Enterprise.EtprType.UnitedEduOrg == Organization.OrgType2EtprType.get(type)){
     ...
     private void refreshTable(){
        ...
        for (Organization o : unitedEduOrg.orgList) {
            Object row[] = new Object[3];
            row[0] = o;
            row[1] = o.getOrgType().name();
            row[2] = o.getCountry().getName();
            model.addRow(row);
        }
     }
    ...
    private void initComponents() {
        ...
        lblTitle.setText("Manage Organizations In United Education Orgnization");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(10, 10, 10)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(countryTxt, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblPressure2))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblTemperature1)
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        unitedEduOrg.orgList.remove(selectedRec);
        refreshTable();
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        Country country = business.getCountryDirectory().getCountryByName(countryTxt.getText());
        Organization.OrgType orgType = Organization.getOrgTypeByName(typeBox.getSelectedItem().toString());
        Organization o = business.getOrganizationDirectory().createOrganization(txtName.getText(), country, orgType, unitedEduOrg);
        unitedEduOrg.orgList.add(o);
